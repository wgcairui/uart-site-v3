...
export const ProtocolThresholdUser: React.FC<UserProps> = ({ protocolName, user, isAdmin }) => {
    ...
    const saveOprates = () => {
        ...
        const saveReq = isAdmin 
            ? modifyAdminUserAlarmSetupProtocol(user, Protocol.data.Protocol, { Threshold: data })
